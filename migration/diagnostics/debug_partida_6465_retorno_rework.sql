-- ============================================================================
-- DIAGNOSTIC: does partida 6465 have production output and a dispatch (entrega)
-- record? Context: it is being returned and must be re-ingressed for rework
-- (rolls were dispatched and need to come back to be weighed again).
